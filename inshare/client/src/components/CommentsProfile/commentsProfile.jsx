...
import styles from './style.commentsProfile.module.scss';
...
const CommentsProfile = ({ userID }) => {
    ...
    const fetchComments = () => {
        ...
        fetch(`/api/comments/user/${parsedUserData._id}`)
            ...
            .then((data) => {
                ...
                Promise.all(data.map(comment => fetchUserData(parsedUserData._id)))
                    .then(users => {
    ...
    return (
        <div>
            ...
            {commentsLoading ? (
                ...
                <>
                    <h4 className='m-2 pb-3' style={{ fontWeight: "600", color: "#F16236" }}>{commentsAmount} Comments</h4>
